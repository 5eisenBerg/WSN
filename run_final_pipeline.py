...
PORT = 5555
MODEL_PATH = os.path.join(CURRENT_DIR, "v55_best.pth")
...
if __name__ == '__main__':
    ...
    for i in range(20): # V55: Increased to 20 evaluation runs
    ...
    print("\n\n--- FINAL RESULTS (V55, MEAN ± 95% CI) ---")
    print(summary_df.to_string())
    summary_df.to_excel("final_results_v55.xlsx")
    print("\n✅ Results exported to 'final_results_v55.xlsx'")
