...
# --- V55 Config (Module 1: Scheduling) ---
...
NS3_PATH = '/home/heisenberg/ns3-workspace/bake/source/ns-3.40'; SIM_SCRIPT = 'wsn_100dynamic'; PORT = 5555; MODEL_PATH = os.path.join(CURRENT_DIR, "v55_best.pth")
...
if __name__=='__main__':
    print("🛠️ V55: Rebuilding NS-3...");build=subprocess.run(f"./ns3 build",cwd=NS3_PATH,shell=True,capture_output=True,text=True)
    ...
    pd.DataFrame(train_log).to_csv("training_log_v55.csv",index=False)
    # ... (evaluation logic is unchanged and robust)
